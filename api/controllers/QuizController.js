            ...
            Gamer.find().where({email: req.param('email')}).exec(function (err, gamer) {
                if(gamer.length == 0) {
                    ...
                    Language.find().done(function (err, languages) {
                        ...
                        if(isSupported) {
                            Question.find().where({level:1, pp: "x"}).exec(function (err, level1Questions) {
                                Question.find().where({level:2, pp: "x"}).exec(function (err, level2Questions) {
                                    Question.find().where({level:3, pp: "x"}).exec(function (err, level3Questions) {
                                        var quizQuestions = []
